...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
	...
	define(['Configuration', 'ApiClient', 'model/ApiError', 'model/FormGroupSummaryList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../Configuration'), require('../ApiClient'), require('../model/ApiError'), require('../model/FormGroupSummaryList'));
  } else {
    // Browser globals (root is window)
    if (!root.DocusignRooms) {
      root.DocusignRooms = {};
    }
    root.DocusignRooms.FormGroupsApi = factory(root.DocusignRooms.Configuration, root.DocusignRooms.ApiClient, root.DocusignRooms.ApiError, root.DocusignRooms.FormGroupSummaryList);
  }
}(this, function(Configuration, ApiClient, ApiError, FormGroupSummaryList) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} optsOrCallback.count Number of Form Groups to include in the response, (Default 100).
     * @param {Number} optsOrCallback.startPosition Position in the overall list of Form Groups to begin results.
