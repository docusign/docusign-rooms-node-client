...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['Configuration', 'ApiClient', 'model/AccessLevel', 'model/AccountStatus', 'model/AccountSummary', 'model/ActivityType', 'model/ApiError', 'model/AssignableRoles', 'model/ClassicManagerPermissions', 'model/ClosingStatus', 'model/ContactSide', 'model/Country', 'model/Currency', 'model/CustomData', 'model/DependsOn', 'model/DesignatedOffice', 'model/DesignatedRegion', 'model/Document', 'model/DocumentUser', 'model/DocumentUserForCreate', 'model/ESignAccountRoleSettings', 'model/ESignPermissionProfile', 'model/ESignPermissionProfileList', 'model/Envelope', 'model/EnvelopeForCreate', 'model/ExternalFormFillSession', 'model/ExternalFormFillSessionForCreate', 'model/Field', 'model/FieldConfiguration', 'model/FieldData', 'model/FieldDataForCreate', 'model/FieldDataForUpdate', 'model/FieldSet', 'model/FieldsCustomDataFilterType', 'model/FinancingType', 'model/FormDetails', 'model/FormForAdd', 'model/FormGroup', 'model/FormGroupForCreate', 'model/FormGroupForUpdate', 'model/FormGroupForm', 'model/FormGroupFormList', 'model/FormGroupFormToAssign', 'model/FormGroupSummary', 'model/FormGroupSummaryList', 'model/FormLibrarySummary', 'model/FormLibrarySummaryList', 'model/FormProviderAssociationSummary', 'model/FormProviderAssociationsSummaryList', 'model/FormSummary', 'model/FormSummaryList', 'model/GlobalActivityTypes', 'model/GlobalClosingStatuses', 'model/GlobalContactSides', 'model/GlobalCountries', 'model/GlobalCurrencies', 'model/GlobalFinancingTypes', 'model/GlobalOriginsOfLeads', 'model/GlobalPropertyTypes', 'model/GlobalRoomContactTypes', 'model/GlobalSellerDecisionTypes', 'model/GlobalSpecialCircumstanceTypes', 'model/GlobalStates', 'model/GlobalTaskDateTypes', 'model/GlobalTaskResponsibilityTypes', 'model/GlobalTaskStatuses', 'model/GlobalTimeZones', 'model/GlobalTransactionSides', 'model/GroupForm', 'model/ListingType', 'model/LockedOutDetails', 'model/MemberSortingOption', 'model/Office', 'model/OfficeForCreate', 'model/OfficeReferenceCount', 'model/OfficeReferenceCountList', 'model/OfficeSummary', 'model/OfficeSummaryList', 'model/OriginOfLead', 'model/Permissions', 'model/ProductVersion', 'model/PropertyType', 'model/Region', 'model/RegionReferenceCount', 'model/RegionReferenceCountList', 'model/RegionSummary', 'model/RegionSummaryList', 'model/Role', 'model/RoleForCreate', 'model/RoleForUpdate', 'model/RoleSummary', 'model/RoleSummaryList', 'model/RolesFilterContextTypes', 'model/Room', 'model/RoomContactType', 'model/RoomDocument', 'model/RoomDocumentList', 'model/RoomDocumentOwner', 'model/RoomFolder', 'model/RoomFolderList', 'model/RoomForCreate', 'model/RoomInvite', 'model/RoomInviteResponse', 'model/RoomPicture', 'model/RoomStatus', 'model/RoomSummary', 'model/RoomSummaryList', 'model/RoomTemplate', 'model/RoomTemplatesSummaryList', 'model/RoomUser', 'model/RoomUserForUpdate', 'model/RoomUserRemovalDetail', 'model/RoomUserSortingOption', 'model/RoomUserSummary', 'model/RoomUsersResult', 'model/SelectListFieldOption', 'model/SellerDecisionType', 'model/SpecialCircumstanceType', 'model/State', 'model/TaskDateType', 'model/TaskList', 'model/TaskListForCreate', 'model/TaskListSummary', 'model/TaskListSummaryList', 'model/TaskListTemplate', 'model/TaskListTemplateList', 'model/TaskResponsibilityType', 'model/TaskStatus', 'model/TaskSummary', 'model/TimeZone', 'model/TransactionSide', 'model/User', 'model/UserForUpdate', 'model/UserSummary', 'model/UserSummaryList', 'model/UserToInvite', 'api/AccountsApi', 'api/ActivityTypesApi', 'api/ClosingStatusesApi', 'api/ContactSidesApi', 'api/CountriesApi', 'api/CurrenciesApi', 'api/DocumentsApi', 'api/ESignPermissionProfilesApi', 'api/ExternalFormFillSessionsApi', 'api/FieldsApi', 'api/FinancingTypesApi', 'api/FormDetailsApi', 'api/FormGroupFormsApi', 'api/FormGroupsApi', 'api/FormLibrariesApi', 'api/FormProviderAssociationsApi', 'api/OfficesApi', 'api/OriginsOfLeadsApi', 'api/PropertyTypesApi', 'api/RegionsApi', 'api/RolesApi', 'api/RoomContactTypesApi', 'api/RoomEnvelopesApi', 'api/RoomFoldersApi', 'api/RoomTemplatesApi', 'api/RoomsApi', 'api/SellerDecisionTypesApi', 'api/SpecialCircumstanceTypesApi', 'api/StatesApi', 'api/TaskDateTypesApi', 'api/TaskListTemplatesApi', 'api/TaskListsApi', 'api/TaskResponsibilityTypesApi', 'api/TaskStatusesApi', 'api/TimeZonesApi', 'api/TransactionSidesApi', 'api/UsersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./Configuration'), require('./ApiClient'), require('./model/AccessLevel'), require('./model/AccountStatus'), require('./model/AccountSummary'), require('./model/ActivityType'), require('./model/ApiError'), require('./model/AssignableRoles'), require('./model/ClassicManagerPermissions'), require('./model/ClosingStatus'), require('./model/ContactSide'), require('./model/Country'), require('./model/Currency'), require('./model/CustomData'), require('./model/DependsOn'), require('./model/DesignatedOffice'), require('./model/DesignatedRegion'), require('./model/Document'), require('./model/DocumentUser'), require('./model/DocumentUserForCreate'), require('./model/ESignAccountRoleSettings'), require('./model/ESignPermissionProfile'), require('./model/ESignPermissionProfileList'), require('./model/Envelope'), require('./model/EnvelopeForCreate'), require('./model/ExternalFormFillSession'), require('./model/ExternalFormFillSessionForCreate'), require('./model/Field'), require('./model/FieldConfiguration'), require('./model/FieldData'), require('./model/FieldDataForCreate'), require('./model/FieldDataForUpdate'), require('./model/FieldSet'), require('./model/FieldsCustomDataFilterType'), require('./model/FinancingType'), require('./model/FormDetails'), require('./model/FormForAdd'), require('./model/FormGroup'), require('./model/FormGroupForCreate'), require('./model/FormGroupForUpdate'), require('./model/FormGroupForm'), require('./model/FormGroupFormList'), require('./model/FormGroupFormToAssign'), require('./model/FormGroupSummary'), require('./model/FormGroupSummaryList'), require('./model/FormLibrarySummary'), require('./model/FormLibrarySummaryList'), require('./model/FormProviderAssociationSummary'), require('./model/FormProviderAssociationsSummaryList'), require('./model/FormSummary'), require('./model/FormSummaryList'), require('./model/GlobalActivityTypes'), require('./model/GlobalClosingStatuses'), require('./model/GlobalContactSides'), require('./model/GlobalCountries'), require('./model/GlobalCurrencies'), require('./model/GlobalFinancingTypes'), require('./model/GlobalOriginsOfLeads'), require('./model/GlobalPropertyTypes'), require('./model/GlobalRoomContactTypes'), require('./model/GlobalSellerDecisionTypes'), require('./model/GlobalSpecialCircumstanceTypes'), require('./model/GlobalStates'), require('./model/GlobalTaskDateTypes'), require('./model/GlobalTaskResponsibilityTypes'), require('./model/GlobalTaskStatuses'), require('./model/GlobalTimeZones'), require('./model/GlobalTransactionSides'), require('./model/GroupForm'), require('./model/ListingType'), require('./model/LockedOutDetails'), require('./model/MemberSortingOption'), require('./model/Office'), require('./model/OfficeForCreate'), require('./model/OfficeReferenceCount'), require('./model/OfficeReferenceCountList'), require('./model/OfficeSummary'), require('./model/OfficeSummaryList'), require('./model/OriginOfLead'), require('./model/Permissions'), require('./model/ProductVersion'), require('./model/PropertyType'), require('./model/Region'), require('./model/RegionReferenceCount'), require('./model/RegionReferenceCountList'), require('./model/RegionSummary'), require('./model/RegionSummaryList'), require('./model/Role'), require('./model/RoleForCreate'), require('./model/RoleForUpdate'), require('./model/RoleSummary'), require('./model/RoleSummaryList'), require('./model/RolesFilterContextTypes'), require('./model/Room'), require('./model/RoomContactType'), require('./model/RoomDocument'), require('./model/RoomDocumentList'), require('./model/RoomDocumentOwner'), require('./model/RoomFolder'), require('./model/RoomFolderList'), require('./model/RoomForCreate'), require('./model/RoomInvite'), require('./model/RoomInviteResponse'), require('./model/RoomPicture'), require('./model/RoomStatus'), require('./model/RoomSummary'), require('./model/RoomSummaryList'), require('./model/RoomTemplate'), require('./model/RoomTemplatesSummaryList'), require('./model/RoomUser'), require('./model/RoomUserForUpdate'), require('./model/RoomUserRemovalDetail'), require('./model/RoomUserSortingOption'), require('./model/RoomUserSummary'), require('./model/RoomUsersResult'), require('./model/SelectListFieldOption'), require('./model/SellerDecisionType'), require('./model/SpecialCircumstanceType'), require('./model/State'), require('./model/TaskDateType'), require('./model/TaskList'), require('./model/TaskListForCreate'), require('./model/TaskListSummary'), require('./model/TaskListSummaryList'), require('./model/TaskListTemplate'), require('./model/TaskListTemplateList'), require('./model/TaskResponsibilityType'), require('./model/TaskStatus'), require('./model/TaskSummary'), require('./model/TimeZone'), require('./model/TransactionSide'), require('./model/User'), require('./model/UserForUpdate'), require('./model/UserSummary'), require('./model/UserSummaryList'), require('./model/UserToInvite'), require('./api/AccountsApi'), require('./api/ActivityTypesApi'), require('./api/ClosingStatusesApi'), require('./api/ContactSidesApi'), require('./api/CountriesApi'), require('./api/CurrenciesApi'), require('./api/DocumentsApi'), require('./api/ESignPermissionProfilesApi'), require('./api/ExternalFormFillSessionsApi'), require('./api/FieldsApi'), require('./api/FinancingTypesApi'), require('./api/FormDetailsApi'), require('./api/FormGroupFormsApi'), require('./api/FormGroupsApi'), require('./api/FormLibrariesApi'), require('./api/FormProviderAssociationsApi'), require('./api/OfficesApi'), require('./api/OriginsOfLeadsApi'), require('./api/PropertyTypesApi'), require('./api/RegionsApi'), require('./api/RolesApi'), require('./api/RoomContactTypesApi'), require('./api/RoomEnvelopesApi'), require('./api/RoomFoldersApi'), require('./api/RoomTemplatesApi'), require('./api/RoomsApi'), require('./api/SellerDecisionTypesApi'), require('./api/SpecialCircumstanceTypesApi'), require('./api/StatesApi'), require('./api/TaskDateTypesApi'), require('./api/TaskListTemplatesApi'), require('./api/TaskListsApi'), require('./api/TaskResponsibilityTypesApi'), require('./api/TaskStatusesApi'), require('./api/TimeZonesApi'), require('./api/TransactionSidesApi'), require('./api/UsersApi'));
  }
}(function(Configuration, ApiClient, AccessLevel, AccountStatus, AccountSummary, ActivityType, ApiError, AssignableRoles, ClassicManagerPermissions, ClosingStatus, ContactSide, Country, Currency, CustomData, DependsOn, DesignatedOffice, DesignatedRegion, Document, DocumentUser, DocumentUserForCreate, ESignAccountRoleSettings, ESignPermissionProfile, ESignPermissionProfileList, Envelope, EnvelopeForCreate, ExternalFormFillSession, ExternalFormFillSessionForCreate, Field, FieldConfiguration, FieldData, FieldDataForCreate, FieldDataForUpdate, FieldSet, FieldsCustomDataFilterType, FinancingType, FormDetails, FormForAdd, FormGroup, FormGroupForCreate, FormGroupForUpdate, FormGroupForm, FormGroupFormList, FormGroupFormToAssign, FormGroupSummary, FormGroupSummaryList, FormLibrarySummary, FormLibrarySummaryList, FormProviderAssociationSummary, FormProviderAssociationsSummaryList, FormSummary, FormSummaryList, GlobalActivityTypes, GlobalClosingStatuses, GlobalContactSides, GlobalCountries, GlobalCurrencies, GlobalFinancingTypes, GlobalOriginsOfLeads, GlobalPropertyTypes, GlobalRoomContactTypes, GlobalSellerDecisionTypes, GlobalSpecialCircumstanceTypes, GlobalStates, GlobalTaskDateTypes, GlobalTaskResponsibilityTypes, GlobalTaskStatuses, GlobalTimeZones, GlobalTransactionSides, GroupForm, ListingType, LockedOutDetails, MemberSortingOption, Office, OfficeForCreate, OfficeReferenceCount, OfficeReferenceCountList, OfficeSummary, OfficeSummaryList, OriginOfLead, Permissions, ProductVersion, PropertyType, Region, RegionReferenceCount, RegionReferenceCountList, RegionSummary, RegionSummaryList, Role, RoleForCreate, RoleForUpdate, RoleSummary, RoleSummaryList, RolesFilterContextTypes, Room, RoomContactType, RoomDocument, RoomDocumentList, RoomDocumentOwner, RoomFolder, RoomFolderList, RoomForCreate, RoomInvite, RoomInviteResponse, RoomPicture, RoomStatus, RoomSummary, RoomSummaryList, RoomTemplate, RoomTemplatesSummaryList, RoomUser, RoomUserForUpdate, RoomUserRemovalDetail, RoomUserSortingOption, RoomUserSummary, RoomUsersResult, SelectListFieldOption, SellerDecisionType, SpecialCircumstanceType, State, TaskDateType, TaskList, TaskListForCreate, TaskListSummary, TaskListSummaryList, TaskListTemplate, TaskListTemplateList, TaskResponsibilityType, TaskStatus, TaskSummary, TimeZone, TransactionSide, User, UserForUpdate, UserSummary, UserSummaryList, UserToInvite, AccountsApi, ActivityTypesApi, ClosingStatusesApi, ContactSidesApi, CountriesApi, CurrenciesApi, DocumentsApi, ESignPermissionProfilesApi, ExternalFormFillSessionsApi, FieldsApi, FinancingTypesApi, FormDetailsApi, FormGroupFormsApi, FormGroupsApi, FormLibrariesApi, FormProviderAssociationsApi, OfficesApi, OriginsOfLeadsApi, PropertyTypesApi, RegionsApi, RolesApi, RoomContactTypesApi, RoomEnvelopesApi, RoomFoldersApi, RoomTemplatesApi, RoomsApi, SellerDecisionTypesApi, SpecialCircumstanceTypesApi, StatesApi, TaskDateTypesApi, TaskListTemplatesApi, TaskListsApi, TaskResponsibilityTypesApi, TaskStatusesApi, TimeZonesApi, TransactionSidesApi, UsersApi) {
  'use strict';
  ...
  var exports = {
    ...
    Envelope: Envelope,
    /**
     * The EnvelopeForCreate model constructor.
     * @property {module:model/EnvelopeForCreate}
     */
    EnvelopeForCreate: EnvelopeForCreate,
    /**
    ...
    /**
     * The FormGroupForm model constructor.
     * @property {module:model/FormGroupForm}
     */
    FormGroupForm: FormGroupForm,
    /**
     * The FormGroupFormList model constructor.
     * @property {module:model/FormGroupFormList}
     */
    FormGroupFormList: FormGroupFormList,
    /**
    ...
    /**
     * The FormProviderAssociationSummary model constructor.
     * @property {module:model/FormProviderAssociationSummary}
     */
    FormProviderAssociationSummary: FormProviderAssociationSummary,
    /**
     * The FormProviderAssociationsSummaryList model constructor.
     * @property {module:model/FormProviderAssociationsSummaryList}
     */
    FormProviderAssociationsSummaryList: FormProviderAssociationsSummaryList,
    /**
    ...
    GroupForm: GroupForm,
    /**
     * The ListingType model constructor.
     * @property {module:model/ListingType}
     */
    ...
    /**
     * The FormGroupFormsApi service constructor.
     * @property {module:api/FormGroupFormsApi}
     */
    FormGroupFormsApi: FormGroupFormsApi,
    /**
    ...
    /**
     * The FormProviderAssociationsApi service constructor.
     * @property {module:api/FormProviderAssociationsApi}
     */
    FormProviderAssociationsApi: FormProviderAssociationsApi,
    /**
    ...
    /**
     * The RoomEnvelopesApi service constructor.
     * @property {module:api/RoomEnvelopesApi}
     */
    RoomEnvelopesApi: RoomEnvelopesApi,
    /**
